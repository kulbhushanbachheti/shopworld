...
return(
    ...
    <form className="form" onSubmit={submitHandler}>
        ...
        <div>
            <label htmlFor="imageFile">Image File

            </label>
            <input id="imageFile" type="file" label="Choose Image" onChange={uploadFileHandler}></input>
        ...
        <div>
            ...
            <textarea id="description"  row="3" type="text" placeholder="Enter description" value={description} onChange={(e) =>setDescription(e.target.value)}></textarea>
